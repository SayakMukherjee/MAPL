...
class DatasetWrapper(datasets.MNIST):
...
class MNIST(BaseDataset):
    ...
    def __init__(self, config: Config, client_id: int, isSSL: bool = False, dataset_args: dict = None):
        ...
        self.data_path = Path(self.config.settings['configurations']['data_path']).joinpath('mnist')
    ...
    def __init_train_dataset(self):
        ...
        self.logger.info(f"Loading MNIST train data")
    ...
    def __init_test_dataset(self):
        ...
        self.logger.info(f"Loading MNIST test data")
