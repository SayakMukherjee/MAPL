...
from models import BaseNet, get_model, load_model, save_model
...
class FedAvgSim():
    ...
    def __initialize_clients(self):
        ...
        for client_id in np.arange(self.num_clients):
            ...
            client = FedAvgSimClients(client_id, self.config, client_model, dataset)
